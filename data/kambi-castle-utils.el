...
(defun kam-process-werewolf-common ()
  (interactive)

  ;; Why the hell blender generates unsensible vertex colors
  ;; for meshes of werewolf ? I don't know.
  ;; But I have to remove them, otherwise werewolf changes
  ;; colors like a rainbow.

  (kam-remove-vertex-col-material-one-mesh "MeshCorpseHead")
  (kam-remove-vertex-col-material-one-mesh "MeshLegsArms")
  (kam-remove-vertex-col-material-one-mesh "MeshTeeth")
...
(defun kam-process-werewolf-still ()
  (interactive)
  (kam-process-werewolf-common)
  (write-file "werewolf_still_processed.wrl")
)

(defun kam-process-werewolf-walk_2 ()
  (interactive)
  (kam-process-werewolf-common)
  (write-file "werewolf_walk_2_processed.wrl")
)

(defun kam-process-werewolf-hurt ()
  (interactive)
  (kam-process-werewolf-common)
  (write-file "werewolf_hurt_processed.wrl")
)

(defun kam-process-werewolf-dead ()
  (interactive)
  (kam-process-werewolf-common)
  (write-file "werewolf_dead_processed.wrl")
)

(defun kam-process-werewolf-attack_1 ()
  (interactive)
  (kam-process-werewolf-common)
  (write-file "werewolf_attack_1_processed.wrl")
)

(defun kam-process-werewolf-attack_2 ()
  (interactive)
  (kam-process-werewolf-common)
  (write-file "werewolf_attack_2_processed.wrl")
)